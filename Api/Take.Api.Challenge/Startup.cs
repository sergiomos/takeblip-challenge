...
using Take.Api.Challenge.Facades.Extensions;
using Take.Api.Challenge.Middleware;
...
namespace Take.Api.Challenge
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var authenticationSettings = Configuration.GetSection(SETTINGS_SECTION).Get<AuthenticationSettings>();
